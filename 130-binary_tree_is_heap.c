 ...
 * Return: the height, by Okpako Michael
 */
 ...
 * it has to be the same quantity of levels in left as right, and also, by Okpako Michael
 ...
 * @tree: tree to check, by Okpako Michael
 * Return: 1 is it is or 0 if not
 */
