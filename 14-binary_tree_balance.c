...
/**
* binary_tree_balance -  measure the balance of a tree, by Okpako Michael
...
/**
* binary_tree_height - measures the height of a binary tree, by Okpako Michael
...
/**
* maxDepth - measures the height of a binary tree, by Okpako Michael
